...
public class StudentWindow extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		accoInfoDormComboBox = new JComboBox();
	...
	private Room getRoomFromText() {
		Room room = new Room();
		if (accoInfoRoomComboBox.getSelectedItem().toString().isEmpty()) {
			room = null;
		} else {
			int roomNo = Integer.parseInt(accoInfoRoomComboBox
	...
	private Hostel getStartEndDateFromText() throws ParseException {
		...
		if (accoInfoStartDateText.getText().isEmpty()
			...
			Date start = convertStringToDatetime(accoInfoStartDateText
					.getText());
	...
	/*
	 * private Hostel getStartEndDateFromText() throws ParseException { Hostel
	 * hostel = new Hostel(); if (accoInfoStartDateText.getText().isEmpty() ||
	 * accoInfoEndDateText.getText().isEmpty()) { hostel.setStartDate(null);
	 * hostel.setStartDate(null); } else { Date start =
	 * convertStringToDatetime(accoInfoStartDateText .getText()); Date end =
	 * convertStringToDatetime(accoInfoEndDateText.getText());
	 * hostel.setStartDate(start); hostel.setStartDate(end); } return hostel; }
	 */
